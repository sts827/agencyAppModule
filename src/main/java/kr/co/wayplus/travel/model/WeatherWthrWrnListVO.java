...
// 기상 특보목록 조회
public class WeatherWthrWrnListVO {
	private static final String weatherType = "twthrWrnList";

	private int wthrWrnListId; 	// 기상 특보목록 ID (PK)
	...
	public int getWthrWrnListId() {
		return wthrWrnListId;
	}
	public void setWthrWrnListId(int wthrWrnListId) {
		this.wthrWrnListId = wthrWrnListId;
	}
	...
	public String toString() {
		return "WeatherWthrWrnListVO [wthrWrnListId=" + wthrWrnListId + ", cityId=" + cityId + ", stnId=" + stnId
