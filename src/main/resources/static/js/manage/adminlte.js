...
(function (global, factory) {
  ...
  var Default$8 = {
    minimizeIcon: 'wi-compress',
    maximizeIcon: 'wi-expand'
  };
  /**
   * Class Definition
   * ====================================================
...
//      console.log(offset, (offset !== false));

      if (offset !== false) {
//		console.log( SELECTOR_CONTROL_SIDEBAR_CONTENT );
//		console.log( $__default["default"](SELECTOR_CONTROL_SIDEBAR_CONTENT).outerHeight() );
//		console.log( `$('${SELECTOR_CONTROL_SIDEBAR_CONTENT}').outerHeight()` );
/*
		console.log('compare1 : ',max, heights.controlSidebar);
		console.log('compare2 : ',max, heights.window);

		console.log(' ------ ');
		console.log('window : ',window, `$(window).outerHeight()`);
		console.log('SELECTOR_HEADER : ',SELECTOR_HEADER, `$('${SELECTOR_HEADER}').outerHeight()`);
		console.log('SELECTOR_FOOTER : ',SELECTOR_FOOTER, `$('${SELECTOR_FOOTER}').outerHeight()`);

		console.log('max', max);
		console.log('offset', offset);
		console.log('header', $__default["default"](SELECTOR_HEADER).length > 0 ? $__default["default"](SELECTOR_HEADER).outerHeight() : 0);
        console.log('footer', $__default["default"](SELECTOR_FOOTER).length > 0 ? $__default["default"](SELECTOR_FOOTER).outerHeight() : 0);
*/
